...
export class AuditoriaComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: AuditoriaService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Auditoria): boolean {
      return true;
   }
   ...
   crearEntidad(): Auditoria {
      const nuevoAuditoria = new Auditoria();
      nuevoAuditoria.id = 0;
      return nuevoAuditoria;
   }

   add(entidadNueva: Auditoria): void {
   ...
   update(entidadParaActualizar: Auditoria): void {
   ...
   delete(entidadParaBorrar: Auditoria): void {
   ...
   onSelect(entidadActual: Auditoria): void {
