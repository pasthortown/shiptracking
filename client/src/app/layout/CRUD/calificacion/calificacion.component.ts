...
export class CalificacionComponent implements OnInit {
   ...
   entidadSeleccionada: Calificacion;
   pagina: 1;
   tamanoPagina: 20;
   paginaActual: number;
   paginaUltima: number;
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: CalificacionService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Calificacion): boolean {
      return true;
   }
   ...
   crearEntidad(): Calificacion {
      const nuevoCalificacion = new Calificacion();
      nuevoCalificacion.id = 0;
      return nuevoCalificacion;
   }

   add(entidadNueva: Calificacion): void {
   ...
   update(entidadParaActualizar: Calificacion): void {
   ...
   delete(entidadParaBorrar: Calificacion): void {
   ...
   onSelect(entidadActual: Calificacion): void {
