...
export class RolComponent implements OnInit {
   ...
   constructor(public toastr: ToastsManager, vcr: ViewContainerRef, private dataService: RolService, private modalService: NgbModal) {
   ...
   isValid(entidadPorEvaluar: Rol): boolean {
      return true;
   }
   ...
   update(entidadParaActualizar: Rol): void {
   ...
   delete(entidadParaBorrar: Rol): void {
   ...
   onSelect(entidadActual: Rol): void {
